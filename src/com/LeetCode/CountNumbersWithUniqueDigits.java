 ...
 * number of steps to get that number and a bitmask which represent which number is 
 * marked as visited so far in the current number). Start with state (0,0,0) 
 * and count all valid number till we reach number of steps equals to 10^n.
 * 
